    ...
    <div>
        <div className="hero min-h-screen mb-10 " >
            <div className="hero-content text-center text-neutral-content">
                ...
                <p className="mb-5 text-sm text-amber-400"> <img height="10" width="10" src="https://www.gstatic.com/lamda/images/gemini_sparkle_blue_33c17e77c4ebbdd9490b683b9812247e257b6f70.svg" /> Powered by Gemini</p>
